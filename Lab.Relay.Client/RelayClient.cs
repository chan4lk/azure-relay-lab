...
namespace Lab.Relay.Client
{
    internal class RelayClient
    {
        private const string RelayNamespace = "whiz-namespace.servicebus.windows.net";

        private const string ConnectionName = "whiz-hybrid";

        private const string KeyName = "RootManageSharedAccessKey";

        private const string Key = "l1SqKgFSCB+4xMT6VMQF8M9V9TqFuOC8C+ARmLsff2g=";
